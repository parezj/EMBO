...
data2 = csvread("./__600k/EMBO_SCOPE_20210427_193940322.csv", 20, 0);
%data = csvread("./EMBO_SCOPE_6kSps_6Hz.csv", 1, 0);
data1 = csvread("./__6k/EMBO_SCOPE_20210427_193952133.csv", 20, 0);
fs1 = 600000;
fs2 = 6000;
...
l=legend(" STM32F103 ADC   Q_e \approx ± 0.8 mV", " ideální 12-bit ADC  Q_e = ± 0.4 mV", " nulová chyba (analogový signál)" , 'Location','best');
l.FontSize = 18;
grid on;
