...
// ADC -------------------------------------------------------------
#define PS_ADC_MODE_ADC1                                       // 1 ADC (1 DMA)              - verified
//#define PS_ADC_MODE_ADC12                                    // 2 full ADCs (2 DMA)        - N/A
//#define PS_ADC_MODE_ADC1234                                  // 4 full ADCs (4 DMA)        - N/A
#define PS_ADC_BIT12                                           // 12-bit mode available      - verified
//#define PS_ADC_BIT8                                          // 8-bit mode available       - N/A
//#define PS_ADC_INTERLEAVED                                   // interleaved mode available - TODO
//#define PS_ADC_DUALMODE                                      // dual mode available        - TODO
...
#define PS_TIM_CNTR_CH         LL_TIM_CHANNEL_CH1 // direct input capture - channel
#define PS_TIM_CNTR_CH2        LL_TIM_CHANNEL_CH2 // indirect input capture - channel
#define PS_TIM_CNTR_CCR        CCR1   // direct input capture - ccr register
#define PS_TIM_CNTR_CCR2       CCR3   // ovf store - ccr register
#define PS_TIM_CNTR_CC(a)      a##CC1 // direct input capture - cc name
#define PS_TIM_CNTR_CC2(a)     a##CC2 // indirect input capture - cc name
#define PS_TIM_CNTR_OVF(a)     a##CH3 // ovf store
//#define PS_TIM_SGEN          TIM6
//#define PS_TIM_SGEN_FREQ     PS_FREQ_PCLK1
//#define PS_TIM_SGEN_MAX      65535

// Max values ------------------------------------------------------
#define PS_DAQ_MAX_MEM         8500      // DAQ max total memory
...
#define PS_MEM_RESERVE         10        // DAQ circ buff memory reserve
...
// LA - GPIO pin numbers -------------------------------------------
#define PS_GPIO_LA_CH1_NUM     1
#define PS_GPIO_LA_CH2_NUM     2
#define PS_GPIO_LA_CH3_NUM     3
#define PS_GPIO_LA_CH4_NUM     4
