...
// device -----------------------------------------------------------
#define EM_DEV_NAME            "EMBO-STM32G431KB-Nucleo32"   // device specific name
...
#define EM_FREQ_HCLK           150000000  // HCLK clock - main
#define EM_FREQ_ADCCLK         60000000   // ADC clock
#define EM_FREQ_PCLK1          150000000  // APB1 clock
#define EM_FREQ_PCLK2          150000000  // APB2 clock
...
#define EM_LED_PIN             8                    // main LED pin
...
// max values ------------------------------------------------------
#define EM_DAQ_MAX_MEM         8800      // DAQ max total memory
