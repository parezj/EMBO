...
// device -----------------------------------------------------------
#define EM_DEV_NAME            "EMBO-STM32G031J6-SO8" // device specific name
#define EM_DEV_COMM            "USART1 (115200 bps)"  // device comm methods
#define EM_LL_VER              "1.3.0"                // STM32 CubeMX LL drivers

// pins ------------------------------------------------------------
#define EM_PINS_SCOPE_VM       "A13-A10"
#define EM_PINS_LA             "A13-A10"
#define EM_PINS_CNTR           "A8"
#define EM_PINS_PWM            "A0"
#define EM_PINS_SGEN           "-"
...
// max values ------------------------------------------------------
#define EM_DAQ_MAX_MEM         1000     // DAQ max total memory in release mode
...
#define EM_LA_IRQ_EXTI1        EXTI4_15_IRQn
#define EM_LA_IRQ_EXTI2        EXTI4_15_IRQn
...
#define EM_LA_EXTI1            LL_EXTI_LINE_13
#define EM_LA_EXTI2            LL_EXTI_LINE_12
//#define EM_LA_EXTI3          LL_EXTI_LINE_4
//#define EM_LA_EXTI4          LL_EXTI_LINE_5
//#define EM_LA_EXTI_UNUSED    LL_EXTI_LINE_2
#define EM_LA_EXTILINE1        LL_EXTI_CONFIG_LINE13
#define EM_LA_EXTILINE2        LL_EXTI_CONFIG_LINE12
//#define EM_LA_EXTILINE3      LL_EXTI_CONFIG_LINE4
//#define EM_LA_EXTILINE4      LL_EXTI_CONFIG_LINE5
#define EM_LA_CH1_IRQh         EXTI4_15_IRQHandler
//#define EM_LA_CH2_IRQh       EXTI4_15_IRQHandler
...
#define EM_LA_IRQ1_CH2         la_irq_ch2
//#define EM_LA_IRQ2_CH3       la_irq_ch3
//#define EM_LA_IRQ4_CH4       la_irq_ch4

// ADC pins --------------------------------------------------------
#define EM_ADC_AWD1            LL_ADC_AWD_CHANNEL_17_REG
#define EM_ADC_AWD2            LL_ADC_AWD_CHANNEL_16_REG
//#define EM_ADC_AWD3          LL_ADC_AWD_CHANNEL_4_REG
//#define EM_ADC_AWD4          LL_ADC_AWD_CHANNEL_5_REG
#define EM_ADC_CH1             LL_ADC_CHANNEL_17
#define EM_ADC_CH2             LL_ADC_CHANNEL_16
...
#define EM_GPIO_ADC_CH1        LL_GPIO_PIN_13
#define EM_GPIO_ADC_CH2        LL_GPIO_PIN_12
//#define EM_GPIO_ADC_CH3      LL_GPIO_PIN_4
//#define EM_GPIO_ADC_CH4      LL_GPIO_PIN_5

// LA - GPIO pins --------------------------------------------------
#define EM_GPIO_LA_PORT        GPIOA
#define EM_GPIO_LA_OFFSET      1
#define EM_GPIO_LA_CH1         LL_GPIO_PIN_13
#define EM_GPIO_LA_CH2         LL_GPIO_PIN_12
//#define EM_GPIO_LA_CH3       LL_GPIO_PIN_4
//#define EM_GPIO_LA_CH4       LL_GPIO_PIN_5

// LA - GPIO pin numbers -------------------------------------------
#define EM_GPIO_LA_CH1_NUM     5
#define EM_GPIO_LA_CH2_NUM     4
