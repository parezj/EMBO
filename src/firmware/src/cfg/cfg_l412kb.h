...
// pins ------------------------------------------------------------
#define EM_PINS_SCOPE_VM       "A0-A1-A3-A4"
#define EM_PINS_LA             "A0-A1-A3-A4"
#define EM_PINS_CNTR           "A8"
#define EM_PINS_PWM            "A5"
#define EM_PINS_SGEN           "-"
...
#define EM_FREQ_HCLK           80000000  // HCLK clock - main
#define EM_FREQ_ADCCLK         80000000  // ADC clock
#define EM_FREQ_PCLK1          80000000  // APB1 clock
#define EM_FREQ_PCLK2          80000000  // APB2 clock
...
#define EM_USB                                      // if emulated USB enab
...
// max values ------------------------------------------------------
#define EM_DAQ_MAX_MEM         25000      // DAQ max total memory
...
#define EM_LA_EXTILINE3        LL_SYSCFG_EXTI_LINE3
#define EM_LA_EXTILINE4        LL_SYSCFG_EXTI_LINE4
