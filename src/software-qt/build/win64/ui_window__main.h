...
"QGroupBox::title {subcontrol-origin: margin;left: 10px;padding: 0 3px 0 3px;}"));
        ...
        label_deviceLogo->setFont(font5);
...
"QGroupBox::title {subcontrol-origin: margin;left: 10px;padding: 0 3px 0 3px;}"));
        ...
        QFont font9;
        font9.setFamily(QString::fromUtf8("Roboto Medium"));
        font9.setPointSize(13);
        font9.setBold(false);
        font9.setWeight(50);
        font9.setKerning(false);
        pushButton_scope->setFont(font9);
...
"}"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/main/resources/img/sgen.svg"), QSize(), QIcon::Normal, QIcon::Off);
