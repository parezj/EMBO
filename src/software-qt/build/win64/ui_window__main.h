...
public:
    ...
    void setupUi(QMainWindow *WindowMain)
    {
        ...
        WindowMain->setMinimumSize(QSize(800, 596));
        WindowMain->setMaximumSize(QSize(800, 596));
        QFont font;
        ...
        actionCheck_Updates->setFont(font2);
        actionOpenProgrammer = new QAction(WindowMain);
        actionOpenProgrammer->setObjectName(QString::fromUtf8("actionOpenProgrammer"));
        actionOpenProgrammer->setFont(font2);
        ...
        groupBox_ports->setGeometry(QRect(10, 180, 221, 361));
...
"QGroupBox::title {subcontrol-origin: margin;left: 10px;padding: 0 3px 0 3px;}"));
        ...
        listWidget_ports->setGeometry(QRect(10, 30, 201, 271));
        ...
        listWidget_ports->setFont(font4);
        listWidget_ports->setStyleSheet(QString::fromUtf8(""));
        listWidget_ports->setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOn);
        listWidget_ports->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        ...
        pushButton_scan->setGeometry(QRect(10, 310, 71, 41));
        QFont font5;
...
"}"));
        ...
        pushButton_connect->setGeometry(QRect(90, 310, 121, 41));
        pushButton_connect->setFont(font5);
...
"}"));
        ...
        pushButton_disconnect->setGeometry(QRect(90, 310, 121, 41));
        pushButton_disconnect->setFont(font5);
...
"QGroupBox::title {subcontrol-origin: margin;left: 10px;padding: 0 3px 0 3px;}"));
        ...
        label_boardImg->setFont(font8);
        label_boardImg->setPixmap(QPixmap(QString::fromUtf8(":/main/resources/img/unknown2.png")));
        label_boardImg->setScaledContents(true);
        label_dev1 = new QLabel(groupBox_device);
        label_dev1->setObjectName(QString::fromUtf8("label_dev1"));
        label_dev1->setGeometry(QRect(10, 50, 141, 16));
        label_dev1->setFont(font6);
        label_dev1->setTextFormat(Qt::AutoText);
        label_dev2 = new QLabel(groupBox_device);
        label_dev2->setObjectName(QString::fromUtf8("label_dev2"));
        label_dev2->setGeometry(QRect(10, 70, 141, 16));
        label_dev2->setFont(font6);
        label_dev2->setTextFormat(Qt::AutoText);
        label_dev3 = new QLabel(groupBox_device);
        label_dev3->setObjectName(QString::fromUtf8("label_dev3"));
        label_dev3->setGeometry(QRect(10, 90, 141, 16));
        label_dev3->setFont(font6);
        label_dev3->setTextFormat(Qt::AutoText);
        label_dev4 = new QLabel(groupBox_device);
        label_dev4->setObjectName(QString::fromUtf8("label_dev4"));
        label_dev4->setGeometry(QRect(10, 110, 141, 16));
        label_dev4->setFont(font6);
        label_dev4->setTextFormat(Qt::AutoText);
        label_dev5 = new QLabel(groupBox_device);
        label_dev5->setObjectName(QString::fromUtf8("label_dev5"));
        label_dev5->setGeometry(QRect(10, 130, 141, 16));
        label_dev5->setFont(font6);
        label_dev5->setTextFormat(Qt::AutoText);
        ...
        label_dev_ll->setFont(font6);
        label_dev_ll->setTextFormat(Qt::AutoText);
        label_dev6 = new QLabel(groupBox_device);
        label_dev6->setObjectName(QString::fromUtf8("label_dev6"));
        label_dev6->setGeometry(QRect(10, 150, 141, 16));
        label_dev6->setFont(font6);
        label_dev6->setTextFormat(Qt::AutoText);
...
"QGroupBox::title {subcontrol-origin: margin;left: 10px;padding: 0 3px 0 3px;}"));
        ...
        pushButton_scope->setFont(font10);
...
"}"));
        ...
        label_scope_bits->setFont(font6);
        ...
        label_scope_modes->setFont(font6);
        ...
        label_scope_pins->setFont(font6);
...
"}"));
        ...
        label_la_protocols->setFont(font6);
...
"QGroupBox::title {subcontrol-origin: margin;left: 10px;padding: 0 3px 0 3px;}"));
        ...
        pushButton_sgen->setFont(font11);
...
""));
        ...
        pushButton_cntr->setFont(font12);
...
"}"));
        ...
        label_cntr_timeout->setFont(font6);
        ...
        groupBox_logo = new QGroupBox(centralwidget);
        groupBox_logo->setObjectName(QString::fromUtf8("groupBox_logo"));
        groupBox_logo->setGeometry(QRect(10, 0, 221, 179));
        sizePolicy1.setHeightForWidth(groupBox_logo->sizePolicy().hasHeightForWidth());
        groupBox_logo->setSizePolicy(sizePolicy1);
        groupBox_logo->setFont(font3);
        groupBox_logo->setStyleSheet(QString::fromUtf8("QGroupBox {background-color: rgb(220,220,220);border: 0px; border-radius: 5px;  margin-top: 0.5em;}; \n"
"QGroupBox::title {subcontrol-origin: margin;left: 10px;padding: 0 3px 0 3px;}"));
        label_cvutlogo = new QLabel(groupBox_logo);
        label_cvutlogo->setObjectName(QString::fromUtf8("label_cvutlogo"));
        label_cvutlogo->setGeometry(QRect(0, 8, 221, 171));
        label_cvutlogo->setStyleSheet(QString::fromUtf8("QLabel { border-image: url(:/main/resources/img/ctu_meas_small.png);}\n"
"\n"
"QLabel:hover {border-image: url(:/main/resources/img/ctu_meas_small2.png); }"));
        label_cvutlogo->setScaledContents(false);
        label_cvutlogo->setAlignment(Qt::AlignCenter);
        WindowMain->setCentralWidget(centralwidget);
        groupBox_logo->raise();
        groupBox_ports->raise();
        groupBox_device->raise();
        groupBox_instr1->raise();
        groupBox_instr2->raise();
        line->raise();
    ...
    void retranslateUi(QMainWindow *WindowMain)
    {
        ...
        label_dev1->setText(QCoreApplication::translate("WindowMain", "\342\200\242 Firmware version:", nullptr));
        label_dev2->setText(QCoreApplication::translate("WindowMain", "\342\200\242 STM LL version:", nullptr));
        label_dev3->setText(QCoreApplication::translate("WindowMain", "\342\200\242 FreeRTOS version:", nullptr));
        label_dev4->setText(QCoreApplication::translate("WindowMain", "\342\200\242 CPU frequency:", nullptr));
        label_dev5->setText(QCoreApplication::translate("WindowMain", "\342\200\242 Communication:", nullptr));
        ...
        label_dev6->setText(QCoreApplication::translate("WindowMain", "\342\200\242 Voltage reference:", nullptr));
